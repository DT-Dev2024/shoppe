      ...
      <div className="header__common-info">
        <div className="header__links">
          ...
          <div className="header__links-app-download">
            ...
            <div className="header__links-app-download-popup">
              <a target="_blank" rel="noopener noreferrer" href="#">
                <img className="header__app-download__qr-img" alt="" />
          ...
          <div className="header__links-socials">
            ...
            >
              <FaFacebook className="header__links-socials-icon" />
            </a>
            <a
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              <FaInstagram className="header__links-socials-icon" />
            </a>
          </div>
        </div>
        <div className="header__notify-and-account">
          ...
          >
            <a href="#" className="header__notification__link">
              <svg
                viewBox="3 2.5 14 14"
                x="0"
                y="0"
          ...
          <div className="header__user-account">
            <a href="#" className="header__user-account__link">
      ...
      <div className="header__search-part">
        ...
        <div className="header__main-search">
          <div className="header__search-frame">
            ...
            />
            <a className="header__search-frame__btn" href="#">
              <FaSearch className="header__search-frame-icon" />
            </a>
          </div>
          <div className="header__search-history-keywords-list">
            <span>Giá đỡ laptop</span>
            <span>Kệ macbook</span>
            <span>Giá đỡ laptop gỗ</span>
            <span>Sạc laptop asus</span>
            <span>Kệ tản nhiệt laptop</span>
            <span>Kê laptop</span>
            <span>Kệ để laptop</span>
            <span>Giá đỡ laptop</span>
          </div>
        </div>
        ...
        <div className="header__cart">
          <a href="#" className="header__cart__link">
            <FaCartShopping className="header__cart-icon" />
          </a>
        </div>
      </div>
    </header>
